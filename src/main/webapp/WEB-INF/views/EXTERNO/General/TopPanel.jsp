		...
		<div class="topbar-search-block">
			<div class="container">
				<form name="buscar" method="get" action="index.php">
					<input type="hidden" name="modulo" value="buscar"> <input type="text" name="buscar" class="form-control" placeholder="Buscar...">
			...
			<div class="row">
				<div class="col-sm-7 col-xs-7">
					...
					<ul class="topbar-list topbar-menu">
						...
						<li class="cd-log_reg hidden-sm hidden-md hidden-lg">
							<strong>
								<a class="cd-signin" href="http://ingsistemas.ufps.edu.co">

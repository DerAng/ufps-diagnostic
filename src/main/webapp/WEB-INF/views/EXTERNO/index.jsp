...
<body class="header-fixed boxed-layout" style="position: relative; min-height: 100%; top: 0px;">
	...
	<div class="wrapper">
		...
		<ul class="pgwSlider">
			<li>
					<a href="www.google.com">
						<img src="resources/ufps/rsc/img/clp_20171111_085650.jpg" alt="">
						<span	style="font-family: inherit; font-size: 0.95em; font-weight: normal; color: #111; cursor: auto;">											
								Una descripcion de de ejemplo Una descripcion de de ejemplo Una descripcion de de ejemplo
								Una descripcion de de ejemplo Una descripcion de de ejemplo Una descripcion de de ejemplo											
						</span>
					</a>
			</li>
								...
								<ul class="row block-grid-v2">			
									...
									<li class="col-md-3 col-sm-6 md-margin-bottom-30" style="padding-left: 14px;">										
											<div class="easy-block-v1">
												<img onclick="openModalImage('modal1')" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt=""
													style="cursor: zoom-in;">
												<div class="easy-block-v1-badge rgba-red"> 2 de Octubre de 2019    </div>
											</div>										
											<div
									...
									<li class="col-md-3 col-sm-6 md-margin-bottom-30" style="padding-left: 14px;">										
											<div class="easy-block-v1">
												<img onclick="openModalImage('modal2')" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt=""
													style="cursor: zoom-in;">
												<div class="easy-block-v1-badge rgba-red"> 3 de Octubre de 2019    </div>
											</div>										
											<div
												class="block-grid-v2-info rounded-bottom  bloques_eventos">
												<h5>
										...
										<li class="col-md-3 col-sm-6 md-margin-bottom-30" style="padding-left: 14px;">										
											<div class="easy-block-v1">
												<img onclick="openModalImage('modal3')" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt=""
													style="cursor: zoom-in;">
												<div class="easy-block-v1-badge rgba-red"> 4 de Octubre de 2019    </div>
											</div>										
											<div
												class="block-grid-v2-info rounded-bottom  bloques_eventos">
												<h5>
										...
										<li class="col-md-3 col-sm-6 md-margin-bottom-30" style="padding-left: 14px;">										
											<div class="easy-block-v1">
												<img onclick="openModalImage('modal4')" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt=""
													style="cursor: zoom-in;">
												<div class="easy-block-v1-badge rgba-red"> 5 de Octubre de 2019    </div>
											</div>										
											<div
												class="block-grid-v2-info rounded-bottom  bloques_eventos">
												<h5>
		...
		<div style="background-color: #b43432; padding-bottom: 10px;">
			<div class="container content-prin profile">
				<div class="row margin-bottom-10 margin-top-10">
					...
					<div class="col-sm-3">
						<a href="https://www.bibliocucuta.org/">
							<div class="service-block-v1 md-margin-bottom-50" style="background: #fff; border-top: 5px solid #f1c40f;">									
								<i class="icon-custom icon-lg rounded-x icon-color-yellow icon-line fa fa-bookmark" style="background: #fff;"></i>
									...
									<p>Lugar: BIBLIOTECA JULIO PEREZ FERRERO</p>
									<p>Fecha: 05 de noviembre del 2019</p>
							</div>
						</a>
					</div>
										<div class="col-sm-3">
		...
		<!--  MODALES -->
		<div id="modal1" class="ufps-image-modal">
				<span class="ufps-image-modal-close">&times;</span> 
				<img class="ufps-image-modal-content" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt="">
				<div class="ufps-image-modal-caption">
					YOUTUBE
				</div>
			</div>			
		<div id="modal2" class="ufps-image-modal">
				<span class="ufps-image-modal-close">&times;</span> 
				<img class="ufps-image-modal-content" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt="">
				<div class="ufps-image-modal-caption">
					YOUTUBE
		...
		<div id="modal3" class="ufps-image-modal">
				<span class="ufps-image-modal-close">&times;</span> 
				<img class="ufps-image-modal-content" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt="">
				<div class="ufps-image-modal-caption">
					YOUTUBE
			...
			<div id="modal4" class="ufps-image-modal">
				<span class="ufps-image-modal-close">&times;</span> 
				<img class="ufps-image-modal-content" src="resources/ufps/rsc/img/clp_ponencia semilleros2.png" alt="">
				<div class="ufps-image-modal-caption">
					YOUTUBE
